...
<head>
    ...
    <title>KÜBRA'NIN KİŞİSEL BLOĞU</title>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#awards">Başarılar / Ödüller</a>
                </li>
            </ul>
        ...
        <footer>
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="GirisYap.aspx">Admin Paneli Giriş</a>
                </li>
            </ul>
            </footer>
    </nav>
    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="education">
            <h2 class="mb-5">EĞİTİM HATAYIM</h2>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
            <div class="my-auto">
                ...
                <ul class="list-inline dev-icons">
                    <li class="list-inline-item" title="SQL">
                        <i class="fas fa-database"></i>
                    </li>
                    <li class="list-inline-item" title="C#-Devexpress">
                        <i class="fab fa-windows"></i>
                    </li>
                    <li class="list-inline-item" title="Asp.Net">
